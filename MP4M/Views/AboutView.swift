    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text("This project respects the copyrights of X68000 freeware authors: GORRY (MXDRVG, pcm8), milk, K.MAEKAWA, m_puusan, Yosshin (MXDRV driver), and others. We do not distribute through App Store to preserve their original intent.")
                    .font(.mp4mTiny)
